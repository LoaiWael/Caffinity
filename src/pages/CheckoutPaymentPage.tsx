                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-brand-black ${errors.address ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={formData.city}
                                                onChange={handleInputChange}
                                                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-brand-black ${errors.city ? 'border-red-500' : 'border-gray-300'
                                                    }`}
                                                placeholder="Dublin"
                                            />
                                            {errors.city && (
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-brand-black ${errors.postalCode ? 'border-red-500' : 'border-gray-300'
                                                    }`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-brand-black ${errors.country ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                            placeholder="Ireland"
                                        />
                                        {errors.country && (
